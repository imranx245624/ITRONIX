...
import EventDetailsModal from "@/components/EventDetailsModal" // adjust path if needed
  ...
  return (
    <>
      ...
      >
        ...
        <p className="font-poppins text-muted-text mb-4 leading-relaxed line-clamp-3 flex-1">
          {event.description}
        </p>
            ...
            <div>
              ...
              <SignedIn>
                <Link
                  ...
                  className="w-full text-center btn-secondary hover:shadow-lg hover:shadow-neon-cyan/50 transition-all duration-300 block"
                >
                  Register
                </Link>
              </SignedIn> */}
